...
import { getProvider, listProviders } from '../../infrastructure/services/aiProviders';
...
export class ConfigManager {
    ...
    async updateSoundsEnabled(enabled: boolean, target?: vscode.ConfigurationTarget): Promise<void> {
        const t = target ?? vscode.ConfigurationTarget.Global;
        await vscode.workspace.getConfiguration(CONFIG.SECTION).update(CONFIG.KEYS.SOUNDS_ENABLED, enabled, t);
    }
