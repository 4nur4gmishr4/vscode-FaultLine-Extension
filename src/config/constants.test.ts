...
describe('Constants Module', () => {
    describe('EXTENSION', () => {
        it('should have correct extension metadata', () => {
            expect(EXTENSION.ID).toBe('faultline');
            expect(EXTENSION.NAME).toBe('FaultLine');
    ...
    describe('CONFIG', () => {
        it('should have correct configuration section', () => {
            expect(CONFIG.SECTION).toBe('faultline');
        });
    ...
    describe('SOUNDS', () => {
        it('should have default sound path', () => {
            expect(SOUNDS.DEFAULT).toBe('packs/default/faultline.mp3');
        });

        it('should have all sound pack names', () => {
            expect(SOUNDS.PACKS.FAULTLINE).toBe('faultline.mp3');
            expect(SOUNDS.PACKS.FAHH_HARD).toBe('faultlinehard.mp3');
    ...
    describe('DEFAULTS', () => {
        it('should have correct default values', () => {
            ...
            expect(DEFAULTS.SOUND_PACK).toBe('faultline.mp3');
    ...
    describe('RESOURCES', () => {
        it('should declare extension-relative resource paths', () => {
            ...
            expect(RESOURCES.LOGO).toBe('resources/faultline-logo.jpeg');
        });
    });
    ...
    describe('WEBVIEW_PANELS', () => {
        it('should expose unique view-type ids per webview', () => {
            ...
            expect(WEBVIEW_PANELS.AI_PROVIDER_WIZARD).toBe('faultlineAiProviderWizard');
        });
    });
